      ...
      {isOpen && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-6 bg-black/90">
          ...
          <div className="relative w-full max-w-3xl hud-panel flex flex-col z-20 shadow-[0_0_30px_rgba(16,185,129,0.15)] overflow-hidden border-hud-emerald">
            ...
            {/* Dynamic CSS Override for Emerald Theme in this modal */}
            ...
            <div className="px-6 py-4 flex items-center justify-between border-b border-hud-emerald/40 bg-black/40">
                <div className="flex flex-col">
                    <h2 className="hud-title text-xl text-hud-emerald tracking-[0.2em] mb-1">ENCRYPTED COMMS</h2>
                    <span className="hud-data text-[9px] text-hud-emerald/60">UPLINK_SECURE // AES-256-GCM // HASH: 0x{Math.floor(Math.random()*16777215).toString(16).padEnd(6,'0').toUpperCase()}AC</span>
                </div>
                <button onClick={() => setIsOpen(false)} className="text-hud-emerald/60 hover:text-hud-emerald transition-colors hud-bracketed px-2 py-1 z-50">
            ...
            <div className="p-6 flex flex-col gap-4 relative">
               ...
               <textarea 
                  ...
                  placeholder="Input intelligence or anomaly report..."
